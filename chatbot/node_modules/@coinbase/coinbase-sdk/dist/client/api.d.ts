...
export declare const ReputationApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAddressRisk: (networkId: string, addressId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ReputationApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAddressRisk(networkId: string, addressId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AddressRisk>>;
};
/**
...
export declare class ReputationApi extends BaseAPI implements ReputationApiInterface {
     ...
     * @memberof ReputationApi
     */
    getAddressRisk(networkId: string, addressId: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<AddressRisk, any>>;
}
/**
