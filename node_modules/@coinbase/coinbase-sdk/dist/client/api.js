...
const ReputationApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAddressRisk: async (networkId, addressId, options = {}) => {
            // verify required parameter 'networkId' is not null or undefined
            (0, common_1.assertParamExists)('getAddressRisk', 'networkId', networkId);
            // verify required parameter 'addressId' is not null or undefined
            (0, common_1.assertParamExists)('getAddressRisk', 'addressId', addressId);
...
const ReputationApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAddressRisk(networkId, addressId, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAddressRisk(networkId, addressId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['ReputationApi.getAddressRisk']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
const ReputationApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAddressRisk(networkId, addressId, options) {
...
class ReputationApi extends base_1.BaseAPI {
     ...
     */
    getAddressRisk(networkId, addressId, options) {
        return (0, exports.ReputationApiFp)(this.configuration).getAddressRisk(networkId, addressId, options).then((request) => request(this.axios, this.basePath));
    }
}
